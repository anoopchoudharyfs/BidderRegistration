...
namespace BidderRegistration.Domain
{
    ...
    public class BidderRepository : IBidderRepository
    {
        ...
        public async Task Persist(BidderData bidder)
        {
            ...
            {
                timer.Stop();
                _telemetryClient.TrackDependency(new DependencyTelemetry("Azure DocumentDB", null, "BidderRegistrationUpsert", bidder.Id.ToString(), startTime, timer.Elapsed, "", exception == null));
            }
        }
