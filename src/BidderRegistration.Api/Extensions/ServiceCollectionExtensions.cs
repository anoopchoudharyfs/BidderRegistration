using BidderRegistration.Api.Application.Policies;
using BidderRegistration.Api.Validators;
using BidderRegistration.Api.Services;
using BidderRegistration.Domain;
using BidderRegistration.Services;
...
using BidderRegistration.Domain.Helpers;
using Azure.Identity;

using FluentValidation;
using BidderRegistration.CorrelationId;
using RequestResponseLogger.Configuration;
using BidderRegistration.HttpHeaders;

namespace BidderRegistration.Api.Extensions
{
    /// <summary>
