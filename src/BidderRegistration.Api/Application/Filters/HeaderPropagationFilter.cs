...
namespace BidderRegistration.Api.Application.Filters
{
    ...
    internal class HeaderPropagationMessageHandlerBuilderFilter : IHttpMessageHandlerBuilderFilter
    {
        ...
        public HeaderPropagationMessageHandlerBuilderFilter(IOptions<Headers> headersOptions, IHttpContextAccessor contextAccessor, IConfiguration config)
        {
        ...
        public Action<HttpMessageHandlerBuilder> Configure(Action<HttpMessageHandlerBuilder> next)
        {
            return builder =>
            {
                builder.AdditionalHandlers.Add(new HeaderPropagationMessageHandler(_headersOptions, _contextAccessor, _config));
                next(builder);
            };
        }
    }
    ...
    public class HeaderPropagationMessageHandler : DelegatingHandler
    {
        ...
        public HeaderPropagationMessageHandler(Headers options, IHttpContextAccessor contextAccessor, IConfiguration config)
        {
        ...
        protected override Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, System.Threading.CancellationToken cancellationToken)
        {
            ...
            //if (_contextAccessor.HttpContext != null && _builderName == nameof(IServiceDiscoveryHelper))
